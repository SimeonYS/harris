...
from ..items import HarrisItem
from itemloaders.processors import TakeFirst

pattern = r'(\xa0)?'

class HarrisSpider(scrapy.Spider):
	name = 'harris'
	start_urls = ['https://newsroom.bmoharris.com/index.php?s=2429&o=0']
	...
	def parse_post(self, response, date):
		...
		item = ItemLoader(item=HarrisItem(), response=response)
